                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={12} md={6}>
                                <div className="clean-wrap--left">
                                    ...
                                    <Link
                                        className="href href--large buffer-y"
                                        to="/"
                                    >
                                        Get in touch{' '}
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} md={6}>
                                            <div className="clean-wrap--left">
                                                ...
                                                <p>
                                                    Deploy revolutionary
                                                    tagclouds user-centred
                                                    virtual; standards-compliant
                                                    24/365 feeds innovate
                                                    monetize, synergies expedite
                                                    ubiquitous reintermediate.
                                                </p>
                                                <ColorButton className="buffer-y">
                                                    Load More{' '}
                                                    <MdArrowForward className="icon-right" />
                        ...
                        <Grid item xs={12} md={6}>
                            <div className="border-and-buffer">
                                ...
                                <h4 className="quote-text">
                                    ...
                                    Developer for the love of everything and
                                    waste water.
                                </h4>
