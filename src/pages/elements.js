            ...
            <article className='post-content page-template no-image'>
                <div className='post-content-body'>
                    ...
                    <dl>
                        ...
                        <dd>
                            <p>
                                Lorem ipsum dolor vestibulum ante ipsum primis
                                in faucibus vestibulum. Blandit adipiscing eu
                    ...
                    <ul className='actions'>
                        <li>
                            <span className='button primary disabled'>
                                Primary
                            </span>
                        </li>
                        <li>
                    ...
                    <pre>
                        <code>
                            i ={' '}
                            <span style={{ color: 'rgb(191,90,242)' }}>0</span>;
                            {'\n'}
                            {'\n'}
                            <span style={{ color: 'rgb(10,132,255)' }}>
                                while
                            </span>{' '}
                            (!deck.
...
const indexQuery = graphql`
    query {
        ...
        medPic: file(
            relativePath: { eq: "sophia-valkova-30139-unsplash.jpg" }
        ) {
            childImageSharp {
                fluid(maxWidth: 1360) {
                    ...GatsbyImageSharpFluid
