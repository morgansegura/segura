...
const TutorialIndex = ({data}) => {
    const siteTitle = data.site.siteMetadata.title
    const tags = data.allMdx.distinct

    return (
        <Layout title={siteTitle}> <SEO title="Projects"/>
            ...
            <S.LayoutWithSidebar>
                <header className="tag-page-head">
                    ...
                    <div>
                        <span>Star Rating by non-members</span> <span>Star Rating by members</span> <span>Updated May 8,
                                                                                                          2020</span>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div>
                            gatsby new gatsby-starter-22cboxes-uno
                            https://github.com/iamtherealgd/gatsby-starter-22boxes-uno (Copy Link)
                        </div>
                        <div>
                            <h3>Tags</h3>
                            <p>Tag1, Tag2, Tag3</p>
                        ...
                        <div>
                            <h3>Features</h3>
                            <p>
                                Work and About pages Work page with blog type content management Personal webiste to
                                create content and put your portfolio items Landing pages for your work items, not just
                                links
                            </p>
                        </div>
                        <div>
            ...
            </S.LayoutWithSidebar> </Layout>
    )
}

const tutorialQuery = graphql`
    query {
        site {
            siteMetadata {
                title
...
export default props => (
    <StaticQuery
        query={tutorialQuery}
        render={data => <TutorialIndex props
                                       data={data}/>}
    />
)
