...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#warnings-for-some-updates-during-render)Warnings for some updates during render

A React component should not cause side effects in other components during rendering.

It is supported to call`setState`during render, but[only for*the same component*](https://reactjs.org/docs/hooks-faq.html#how-do-i-implement-getderivedstatefromprops). If you call`setState`during a render on a different component, you will now see a warning:
...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#warnings-for-conflicting-style-rules)Warnings for conflicting style rules
...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#warnings-for-some-deprecated-string-refs)Warnings for some deprecated string refs

[String Refs is an old legacy API](https://reactjs.org/docs/refs-and-the-dom.html#legacy-api-string-refs)which is discouraged and is going to be deprecated in the future:
...
**You most likely don’t have code like this**. If you do and it is intentional, convert it to[`React.createRef()`](https://reactjs.org/docs/refs-and-the-dom.html#creating-refs)instead:
...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#deprecating-reactcreatefactory)Deprecating`React.createFactory`

[`React.createFactory`](https://reactjs.org/docs/react-api.html#createfactory)is a legacy helper for creating React elements. This release adds a deprecation warning to the method. It will be removed in a future major version.
...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#deprecating-reactdomunstable_createportal-in-favor-of-reactdomcreateportal)Deprecating`ReactDOM.unstable_createPortal`in favor of`ReactDOM.createPortal`
...
## [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#other-improvements)Other Improvements

### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#component-stacks-in-hydration-warnings)Component stacks in hydration warnings
...
[![A screenshot of the console warning, simply stating the nature of the hydration mismatch: ](https://reactjs.org/static/20bd06e254e7ad32aa007a59a41d1e65/1e088/hydration-warning-before.png)](https://reactjs.org/static/20bd06e254e7ad32aa007a59a41d1e65/61583/hydration-warning-before.png)
...
[![A screenshot of the console warning, stating the nature of the hydration mismatch, but also including a component stack : ](https://reactjs.org/static/abf3b580867e79d5f377330842bb6522/1e088/hydration-warning-after.png)](https://reactjs.org/static/abf3b580867e79d5f377330842bb6522/d3d45/hydration-warning-after.png)

This makes it clear where the problem is, and lets you locate and fix the bug faster.

### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#notable-bugfixes)Notable bugfixes
...
We’re thankful to all the contributors who helped surface and fix these and other issues. You can find the full changelog[below](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#changelog).

## [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#installation)Installation

### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#react)React
...
Refer to the documentation for[detailed installation instructions](https://reactjs.org/docs/installation.html).

## [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#changelog)Changelog
...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#react-dom)React DOM
...
* Warn when a function component is updated during another component’s render phase ([@acdlite](https://reactjs.org/blog/2020/02/26/(https://github.com/acdlite))in[\#17099](https://github.com/facebook/react/pull/17099))
...
### [](https://reactjs.org/blog/2020/02/26/react-v16.13.0.html#concurrent-mode-experimental)Concurrent Mode (Experimental)
